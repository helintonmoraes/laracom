...
<a class="btn btn-primary" href="<?php echo e(url('/pedido/listagem-de-pedidos',$cliente->id)); ?>"> Ver pedidos de <?php echo e($cliente->nome); ?></a>
...
<br/>
<h3>Pontos Acumulados: <span style="color: red;"><?php echo e($cliente->saldo_pontos); ?></span> pontos</h3>
<br/>
<br/>
