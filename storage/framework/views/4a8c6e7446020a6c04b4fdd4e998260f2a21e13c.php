...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(URL::asset('http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css')); ?>">
...
<script src="<?php echo e(URL::asset('admin/datapicker/js/jquery-ui.js')); ?>"></script>
