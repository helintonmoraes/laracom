        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="{{URL::asset('painel/top-cliente')}}">Top 5 - Clientes</a>
                    </li>
            ...
            <li>
                <a href="{{url('painel/boletos-ativos')}}"><i class="fa fa-cc-mastercard"></i> Boletos Ativos<span class="fa arrow"></span></a>
